...
When passing the [IBMQ API token and instance information](../docs/getting-started.md#1-ibm-quantum-prerequisites) via the Camunda Connector Secrets syntax, they must be stored in an .env File since the Camunda Secrets cannot be accessed by the quantum-sidecar.
Hence, create your `.env` file*                                                                                                                                                                                                                                                                                                                                                                                
                                                                                                                                                                                                                                                                                                                                                                                                               
Copy the [template](/example/predefined-algorithms/example.env) and fill in your credentials:                                                                                                                                                                                                                                                                                                                                                                 
...
```dotenv                                                                                                                                                                                                                                                                                                                                                                                                       
   IBMQ_API_KEY=<your-ibm-quantum-api-token>                                                                                                                                                                                                                                                                                                                                 
   IBMQ_INSTANCE=<crn-or-hub/group/project>                                                                                                                                                                                                                                                                                                                                                
```                                                                                                                                                                                                                                                                                                                                                                                                             
